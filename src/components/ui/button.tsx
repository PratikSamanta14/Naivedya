  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Festive variant - Primary action with gold accent
        festive: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-card hover:shadow-elevated border-b-4 border-secondary active:border-b-2 active:translate-y-[2px]",
        // Hero variant - For hero section CTAs
        hero: "bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-glow hover:shadow-elevated font-bold tracking-wide",
